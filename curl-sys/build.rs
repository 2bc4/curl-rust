...
fn main() {
    ...
    cfg.out_dir(&build)
        ...
        .define("CURL_DISABLE_BINDLOCAL", None)
        .define("CURL_DISABLE_COOKIES", None)
        .define("CURL_DISABLE_BASIC_AUTH", None)
        .define("CURL_DISABLE_BEARER_AUTH", None)
        .define("CURL_DISABLE_DIGEST_AUTH", None)
        .define("CURL_DISABLE_KERBEROS_AUTH", None)
        .define("CURL_DISABLE_NEGOTIATE_AUTH", None)
        .define("CURL_DISABLE_AWS", None)
        .define("CURL_DISABLE_DOH", None)
        .define("CURL_DISABLE_FORM_API", None)
        .define("CURL_DISABLE_GETOPTIONS", None)
        .define("CURL_DISABLE_HEADERS_API", None)
        .define("CURL_DISABLE_LIBCURL_OPTION", None)
        .define("CURL_DISABLE_MIME", None)
        .define("CURL_DISABLE_MQTT", None)
        .define("CURL_DISABLE_PARSEDATE", None)
        .define("CURL_DISABLE_PROGRESS_METER", None)
        .define("CURL_DISABLE_SHUFFLE_DNS", None)
        .define("CURL_DISABLE_SOCKETPAIR", None)
        .define("CURL_DISABLE_PROXY", None)
        .define("CURL_DISABLE_OPENSSL_AUTO_LOAD_CONFIG", None)
        .define("CURL_DISABLE_NETRC_PARSER", None)
        .define("CURL_DISABLE_HTTP_AUTH", None)
        .define("CURL_DISABLE_FILE", None)
